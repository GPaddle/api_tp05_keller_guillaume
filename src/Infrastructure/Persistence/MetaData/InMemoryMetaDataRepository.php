...
class InMemoryMetaDataRepository implements MetaDataRepository
{
	...
	public function __construct(array $categories = null)
	{
		$this->categories = $categories ?? [
			...
			10 => new MetaData(10, "Acidité", "+"),
			11 => new MetaData(11, "Acidité", "+"),
			12 => new MetaData(12, "Précaution d'emplois", "Ne pas manger l'écorce"),
			13 => new MetaData(13, "Fun fact", "Ne vous aidera pas à échapper au tribunal"),
			14 => new MetaData(14, "Fun fact", "Les enfants n'aiment pas ça"),
			15 => new MetaData(15, "Fun fact", "N'est pas un film"),
			16 => new MetaData(16, "Fun fact", "Peut se transformer en popcorn magique"),
			17 => new MetaData(17, "Fun fact", "Vous donnera une haleine à repousser un monstre"),
			18 => new MetaData(18, "Fun fact", "Selon la légende, elle rend aimable"),
			19 => new MetaData(19, "Fun fact", "Vous fera pleurer si vous osez lui faire du mal"),
